    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SEEKER', 'Seeker'), ('SHELTER', 'Shelter')], default='SEEKER', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            bases=('accounts.petpaluser',),
            managers=[
                ('seeker', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Shelter',
